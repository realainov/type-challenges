...
type UnionLast<T> = UnionToIntersection<T extends any ? (arg: T) => any : never> extends (arg: infer A) => any
    ? A
    : never;

export type UnionToTuple<T, U extends any[] = [], L = UnionLast<T>> = [T] extends [never]
    ? U
    : UnionToTuple<Exclude<T, L>, [...U, L]>;
