...
type CurriedFunction<T extends Function> = T extends (...args: infer P) => infer R
    ? Length<P> extends 0 | 1
        ? T
        : P extends [infer PF, ...infer PR]
        ? (arg: PF) => CurriedFunction<(...args: PR) => R>
        : T
    : never;

declare function Currying<T extends Function>(fn: T): CurriedFunction<T>;
