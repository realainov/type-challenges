...
import type { RemoveIndexSignature } from '@medium/1367-remove-index-signature';
import type { IsTuple } from '@medium/4484-is-tuple';
import type { ToNumber } from '@hard/300-string-to-number';
